...
func (s *deviceStoreImpl) SetCallback(callback managerCallback) {
	s.callback = callback
}
...
func (s *alwaysEmptyDeviceStore) SetCallback(callback managerCallback) {
}
